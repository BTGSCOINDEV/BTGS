...
class TransactionTimeRescanTest(BitcoinTestFramework):
    ...
    def run_test(self):
        ...
        minernode = self.nodes[0]  # node used to mine BTGS and create transactions
        ...
        # generate some btgs to create transactions and check blockcount
        ...
        # send 10 btgs to user's first watch-only address
        self.log.info('Send 10 btgs to user')
        ...
        # send 5 btgs to our second watch-only address
        self.log.info('Send 5 btgs to user')
        ...
        # send 1 btgs to our third watch-only address
        self.log.info('Send 1 btgs to user')
