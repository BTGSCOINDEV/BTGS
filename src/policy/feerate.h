...
const std::string CURRENCY_UNIT = "BTGS"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BTGS_KVB,      //!< Use BTGS/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BTGS_KVB) const;
